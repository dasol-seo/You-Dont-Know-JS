...
하지만 자바스크립트의 `string`값은 일반적인 알파벳 규칙을 사용하므로 비일치로도 비교가 가능합니다 (`"bar" < "foo"`).
...
**Note:** 더 많은 비일치 규칙을 알고 싶으시다면 ES5의 기술명세서 중 11.8.5 부분을 확인해 보세요. 또한 Types & Grammar시리즈의 4장을 참고하세요.
